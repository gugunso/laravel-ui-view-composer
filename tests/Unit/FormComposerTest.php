...
use Gugunso\CommonStructures\StackableArray;
use Gugunso\LaravelUiViewComposer\Contract\FormValueApplier;
use Gugunso\LaravelUiViewComposer\Contract\ViewComposerInterface;
use Gugunso\LaravelUiViewComposer\Contract\ViewParameterCreator;
use Gugunso\LaravelUiViewComposer\Exception\InvalidFormValuesApplierException;
...
/**
 * @coversDefaultClass \Gugunso\LaravelUiViewComposer\FormComposer
 * Gugunso\LaravelUiViewComposer\Tests\Unit\FormComposerTest
 */
class FormComposerTest extends TestCase
{
    ...
    public function test_addFormValuesApplier()
    {
        ...
        $stubArray = \Mockery::mock(StackableArray::class)->shouldIgnoreMissing();
